/*
 * PROJECT:    7-Zip Shell Extension
 * FILE:       SevenZip.ShellExtension.cpp
 * PURPOSE:    Implementation for 7-Zip Shell Extension
 *             Based on NanaZip Shell Extension
 *
 * LICENSE:    LGPL (7-Zip) / MIT (NanaZip)
 *
 * MAINTAINER: Forked from NanaZip for 7-Zip compatibility
 */
...
#pragma region IExplorerCommand
            ...
            _In_opt_ IBindCtx* pbc)
        {
            ...
            case CommandID::Open:
            {
                ...
                NWindows::MyCreateProcess(::Get7ZipPath(), params);
...
#pragma endregion
    ...
    private:
            ...
            _In_opt_ IShellItemArray* psiItemArray)
        {
            ...
            using SevenZip::ShellExtension::ExplorerCommandBase;
...
#pragma endregion
    ...
    struct DECLSPEC_UUID("7A8B9C2D-4E5F-4A1B-8C3D-9E0F1A2B3C4D")
    ...
    _Outptr_ LPVOID* ppv)
{
    ...
    if (rclsid != __uuidof(SevenZip::ShellExtension::ClassFactory))
    {
        return E_INVALIDARG;
    }
    ...
    try
    {
        return winrt::make<SevenZip::ShellExtension::ClassFactory>(
